...
ffx_allyears <- DBI::dbGetQuery(con, statement = paste(
  ...
  bedrooms, total_baths, full_baths, half_baths, parcel_level_latitude, parcel_level_latitude, parcel_level_longitude, block_level_latitude, block_level_longitude",
